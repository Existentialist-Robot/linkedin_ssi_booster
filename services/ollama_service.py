    ...
    def generate_linkedin_post(
        ...
        if channel == 'facebook':
            ...
            _platform_block = (
                ...
                f'- Target length: up to {FACEBOOK_CHAR_LIMIT} characters\n'
                f'- More personal, direct, and opinionated than LinkedIn - you can be blunt\n'
                f'- Conversational first-person voice; contractions are fine\n'
                f"- No corporate framing - write like you'd talk to a smart peer\n"
                f'- 2-5 hashtags maximum, only if they genuinely fit\n'
                f'- Do NOT use LinkedIn-style polish or filler CTAs\n'
            )
        elif channel == 'instagram':
            max_length = INSTAGRAM_CHAR_LIMIT
            _platform_block = (
                f'\nIMPORTANT - this post is for Instagram, NOT LinkedIn:\n'
                f'- Hard limit: {INSTAGRAM_CHAR_LIMIT} characters\n'
                f'- First 125 characters are visible before the "more" cutoff - make the hook count\n'
                f'- Punchy, direct, and personal - your unfiltered take\n'
                f'- You can be cutting; Instagram rewards strong opinions\n'
                f'- 5-15 relevant hashtags at the very end (separated by a blank line)\n'
                f'- Do NOT use LinkedIn structure, jargon, or hollow closings\n'
            )
        elif channel == "x":
...
"""
            ...
            _platform_block = f"""\nIMPORTANT -- this post is for Threads, NOT LinkedIn:
...
- No hashtags -- they will NOT be appended for Threads
...
Do NOT include the article URL -- it will be appended automatically."""
            ...
            format_instructions = f"""IMPORTANT -- this post is for Threads, NOT LinkedIn:
...
- Write 1-3 complete sentences or two very short paragraphs. Target under {_text_budget - 40} characters -- leave margin so nothing gets cut.
