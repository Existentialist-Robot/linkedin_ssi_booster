...
| `tests/test_continual_learning.py` | ExtractedFact/ExtractedKnowledgeGraph schema, loader, normalization, deduplication, integration, and **noise filtering pipeline** (first-person narration, truncated RSS fragments, newsletter preambles, navigation blobs, zero-signal sentences). |
